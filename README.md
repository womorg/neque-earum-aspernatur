...
<a href="https://www.npmjs.com/package/@womorg/neque-earum-aspernatur">
  <img alt="npm version" src="https://img.shields.io/npm/v/@womorg/neque-earum-aspernatur.svg?style=flat-square" />
</a>
<a href="https://www.npmjs.com/package/@womorg/neque-earum-aspernatur">
  <img alt="npm downloads" src="https://img.shields.io/npm/dm/@womorg/neque-earum-aspernatur.svg?style=flat-square" />
</a>
...
```bash
# using npm
npm install -D @womorg/neque-earum-aspernatur
# using pnpm
pnpm install -D @womorg/neque-earum-aspernatur
# using yarn
yarn add --dev @womorg/neque-earum-aspernatur
```
...
```ts
import { svgSpritemap } from '@womorg/neque-earum-aspernatur';
